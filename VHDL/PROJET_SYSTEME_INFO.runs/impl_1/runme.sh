...
HD_PWD='/home/starck/Bureau/Automates et Langages/FPGA/VHDL/PROJET_SYSTEME_INFO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UAL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UAL.tcl -notrace
